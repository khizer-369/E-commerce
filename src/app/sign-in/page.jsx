...
const Page = () => {
    ...
    return (
        <div className="h-screen flex justify-center items-center">
            <div className="h-115 w-87 sm:w-102 flex justify-center items-center border shadow-md">
                <form onSubmit={signInHandler} className="h-103 w-75 sm:w-87 flex flex-col justify-between text-sm">
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        <Link href={"/sign-up"} className="ml-1 font-medium">Signup</Link>
                    </div>
                </form>
            </div>
        </div>
